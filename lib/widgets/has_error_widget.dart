...
class HasErrorWidget extends StatelessWidget {
  const HasErrorWidget({
    this.message = 'Ocorreu um erro desconhecido e não foi possível concluir a operação. Por favor, tente novamente em instantes ou acione o suporte!',
    this.callback,
